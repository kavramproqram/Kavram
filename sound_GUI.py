...
from PyQt5.QtGui import QPainter, QPen, QColor, QCursor, QBrush, QPainterPath
    ...
    # PortAudio'nun ALSA yerine PulseAudio'yu (veya PipeWire'ın PulseAudio katmanını)
    # kullanmaya zorlanmasını sağlar. Bu, 'Invalid sample rate' ve Unknown PCM kartı hatalarını çözer.
#    os.environ['ALSA_DEFAULT_DEVICE'] = 'pulse'
    
    # Bazı sistemlerde JACK ses sunucusu hatası almamak için başlatılmasını engeller.
...
class SoundEditorWindow(QWidget):
    ...
    def buttonStyle(self):
        return """
            ...
            QComboBox::down-arrow { image: url(data:image/svg+xml;base64,); width: 16px; height: 16px; }
