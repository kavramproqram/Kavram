...
# ------------------------------------------------------------
# 3. DATA DOSYALARI (SADECE OKUMA GEREKENLER)
# ------------------------------------------------------------
datas = []

# Kök dizindeki veri dosyaları (sadece okuma gerekenler)
...
# SADECE OKUMA KLASÖRLERİ (ikon, veri - salt okunur şablonlar)
# NOT: Export, medya_cut, _v&s_, Zaman_Veri gibi çalışma zamanı klasörleri buradan çıkarıldı
folders = ['ikon', 'veri']
for folder in folders:
    ...
    if os.path.exists(src):
        ...
        print(f"[UYARI] Klasör bulunamadı: {src}")
